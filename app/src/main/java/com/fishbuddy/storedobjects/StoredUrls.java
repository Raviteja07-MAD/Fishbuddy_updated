...
public class StoredUrls {
   ...
   //public static String imageupload="https://13.239.117.192/Sign/api/upload-delivery-photo?";
   // public static String imageupload="https://kidtracker.in/beta_3_0//app/uploadfile.php?";
  // public static String imageupload="http://demos.customerwebdemo.com/FishBuddy/app/uploadfile.php?";

    public static String youtubelink = "";


    public static String imageupload_new = "http://ec2-13-126-208-123.ap-south-1.compute.amazonaws.com/image/upload";
    public static String breedimagecheck_url = "http://ec2-13-126-208-123.ap-south-1.compute.amazonaws.com/classify/?file=";
    ...
    public static String fishing_clubs = "fishing-clubs";
    ...
    public static String suppliers_list = "suppliers";
...
//   "uname=wadmin&pword=wadmin";
    ...
    /*
    get youtubevideo details
    https://www.youtube.com/oembed?url=http://www.youtube.com/watch?v=r5pVTvvcpjg&format=json
    https://img.youtube.com/vi/GDFUdMvacI0/0.jpg
    for image
