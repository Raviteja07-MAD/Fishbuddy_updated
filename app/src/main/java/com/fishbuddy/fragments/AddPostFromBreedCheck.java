...
public class AddPostFromBreedCheck extends Fragment {
    TextView title_txt;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle!=null){
           // datasign();
            ...
            String address = getCompleteAddressString(getActivity(),gpsTracker.getLatitude(),gpsTracker.getLongitude());
            ...
            if (InterNetChecker.isNetworkAvailable(getActivity())) {
                new ImageUploadTaskNew().execute( StoredObjects.scanned_imagepath );
            }else{
